                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a title="Delete Product Image" class="confirmDelete" record="product-images" recordid="{{ $image['id'] }}" href="javascript:void(0)" <?php /* href="{{ url('admin/delete-product-attributes/'.$image['id']) }}" */ ?> ><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
