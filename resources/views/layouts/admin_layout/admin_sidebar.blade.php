  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="image">
                  <img src="{{ asset('images/admin_images/admin_photos/'. Auth::guard('admin')->user()->image) }}" class="img-circle elevation-2"
                      alt="User Image">
              </div>
              <div class="info">
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item menu-open">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="{{ url('/admin/update-admin-detail') }}" class="nav-link @if (Session::has('page') && Session::get('page') == 'update-admin-detail') active @endif">
                                  <i class="far fa-circle nav-icon"></i>
